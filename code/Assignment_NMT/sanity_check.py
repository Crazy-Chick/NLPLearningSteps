...
def question_1d_sanity_check(model, src_sents, tgt_sents, vocab):
    ...
    # Load Outputs
    enc_hiddens_target = torch.load('D:/ML_learn/CS224nAssignmentCode/a4/sanity_check_en_es_data/enc_hiddens.pkl')
    dec_init_state_target = torch.load('D:/ML_learn/CS224nAssignmentCode/a4/sanity_check_en_es_data/dec_init_state.pkl')
...
def main():
    ...
    train_data_src = read_corpus('D:/ML_learn/CS224nAssignmentCode/a4/sanity_check_en_es_data/train_sanity_check.es', 'src')
    train_data_tgt = read_corpus('D:/ML_learn/CS224nAssignmentCode/a4/sanity_check_en_es_data/train_sanity_check.en', 'tgt')
